...
namespace Doppler.AccountPlans
{
    public class AuthorizationTest : IClassFixture<WebApplicationFactory<Startup>>
    {
        ...
        [Theory]
        [InlineData("/accounts/123/newplan/1/1234/calculate-amount?promocode=PROMO-123", HttpStatusCode.Unauthorized)]
        [InlineData("/accounts/test1@test.com/newplan/1/123/calculate-amount?promocode=PROMO-123", HttpStatusCode.Unauthorized)]
        ...
        [Theory]
        [InlineData("/accounts/123/newplan/1/1234/calculate-amount?promocode=PROMO-123", TOKEN_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        [InlineData("/accounts/123/newplan/1/1234/calculate-amount?promocode=PROMO-123", TOKEN_SUPERUSER_FALSE_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        [InlineData("/accounts/456/newplan/1/1234/calculate-amount?promocode=PROMO-123", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        [InlineData("/accounts/test1@test.com/newplan/1/123/calculate-amount?promocode=PROMO-123", TOKEN_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        [InlineData("/accounts/test1@test.com/newplan/1/123/calculate-amount?promocode=PROMO-123", TOKEN_SUPERUSER_FALSE_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        [InlineData("/accounts/test2@test.com/newplan/1/123/calculate-amount?promocode=PROMO-123", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        ...
        [Theory]
        [InlineData("/accounts/123/newplan/1/1234/calculate-amount?promocode=PROMO-123", TOKEN_SUPERUSER_EXPIRE_20330518, HttpStatusCode.OK)]
        [InlineData("/accounts/test1@test.com/newplan/1/123/calculate-amount?promocode=PROMO-123", TOKEN_SUPERUSER_EXPIRE_20330518, HttpStatusCode.OK)]
        [InlineData("/accounts/test1@test.com/newplan/1/123/calculate-amount?promocode=PROMO-123", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20330518, HttpStatusCode.OK)]
        public async Task GET_account_endpoint_should_accept_valid_token_with_isSU_flag_or_a_token_for_the_right_account(string url, string token, HttpStatusCode expectedStatusCode)
        {
            ...
            promotionRepositoryMock.Setup(x => x.GetPromotionByCodeAndPlanId(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<bool>()))
