...
namespace Doppler.AccountPlans
{
    public class GetPlanInformationTest : IClassFixture<WebApplicationFactory<Startup>>
    {
        ...
        {
            // Arrange
            const string expectedContent = "{\"emailQty\":100000,\"fee\":180,\"subscribersQty\":0,\"type\":\"STANDARD\",\"currentMonthPlan\":0,\"idUserType\":0,\"discountPlanFeeAdmin\":0,\"chatPlanFee\":null,\"chatPlanConversationQty\":null,\"printQty\":null}";
